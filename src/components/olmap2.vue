...
export default {
    ...
    mounted(){
        ...
        var webKey = 'f01b325cafc717ab270bc410a7f7fddc';
        var wmtsUrl_1 = 'http://t{0-7}.tianditu.gov.cn/vec_c/wmts?tk=f01b325cafc717ab270bc410a7f7fddc'; //矢量底图
        var wmtsUrl_2 = 'http://t{0-7}.tianditu.gov.cn/cva_c/wmts?tk=f01b325cafc717ab270bc410a7f7fddc'; //矢量注记
        this.view = new View({
            center:[116.0,40.040],
